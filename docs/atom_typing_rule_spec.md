...
- [rules/pcff_atom_types.json](../rules/pcff_atom_types.json)
- optional phase1 bundle: [rules/phase1_family_rule_bundle.json](../rules/phase1_family_rule_bundle.json)

Engine code lives at:

- [src/atom_typing](../src/atom_typing)
