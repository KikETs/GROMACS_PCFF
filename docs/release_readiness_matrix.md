...
| M11.4/M11.6 dense charged-box staged parity | `exact` for explicit paired campaigns | M11.4/M11.6 reports | High-pressure and pressure-preconditioned staged `1 bar` only; not direct ambient equilibrium |
...
| Gate I CPU exact-rRESPA charged conditioning | `exact` for dated Gate I campaign | Gate I PASS manifest | Density/volume conditioning only; not transport readiness |
...
| PolyGen exact r-RESPA CPU/GPU transport screening | `screening-only` | 2026-05-10 PolyGen screening report | 10 ns GROMACS CPU/GPU NE screening only; cNE0 remains diagnostic |
