...
enum class WallCycleCounter : int
{
    ...
    ExactRespaGpuH2DX,
    ExactRespaGpuClear,
    ExactRespaGpuLaunchNb,
    ExactRespaGpuD2HF,
    ExactRespaGpuWaitNb,
    ExactRespaGpuAddF,
    ExactRespaGpuVirial,
    ExactRespaGpuBondedH2DX,
    ExactRespaGpuBondedList,
    ExactRespaGpuBondedClear,
    ExactRespaGpuBondedLaunch,
    ExactRespaGpuBondedD2HF,
    ExactRespaGpuBondedWait,
    ExactRespaGpuBondedAddF,
    ExactRespaGpuBondedEnergy,
    ExactRespaForceSetup,
    ExactRespaCpuListed,
    ExactRespaLongRange,
