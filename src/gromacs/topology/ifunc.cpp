...
const gmx::EnumerationArray<InteractionFunction, t_interaction_function> interaction_function = {
    ...
    def_bondnb("BOND_CLASS2", "Class2 Bond", 2, 4, 0),
    ...
    def_angle("ANGLE_CLASS2", "Class2 Angle", 3, 11, 0),
    ...
    def_dihedral("DIHEDRAL_CLASS2", "Class2 Dih.", 4, 32, 0),
    def_dihedral("IDIHS", "Improper Dih.", 4, 2, 2),
    def_dihedral("IMPROPER_CLASS2", "Class2 Impr.", 4, 8, 0),
