...
def main() -> None:
    parser = argparse.ArgumentParser(description="Assign deterministic repository-local PCFF bonded parameters.")
    ...
    parser.add_argument("--rules", default=None, help="Parameter rules path")
